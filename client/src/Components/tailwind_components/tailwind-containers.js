...
const HeaderContainer = tw.header`relative flex justify-center z-20 bg-indigo-600 py-3 pl-5 pr-3 sm:pl-6 sm:pr-4 md:pr-3.5 lg:px-6 space-x-4 antialiased border-b border-gray-500`;
